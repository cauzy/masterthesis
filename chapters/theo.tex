...
Furthermore, security and QoS levels can be applied and examined in the simulation to develop a system that suits the needs for differnent environments (bandwidth, storage, etc.).